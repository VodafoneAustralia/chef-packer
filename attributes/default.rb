...
# https://releases.hashicorp.com/packer/${VERSION}/${VERSION}_SHA256SUMS
...
filename = "#{node['packer']['version']}/packer_#{node['packer']['version']}_#{node['os']}_#{node['packer']['arch']}.zip"
